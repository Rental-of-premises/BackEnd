...
CREATE INDEX idx_apartment_amenities_apartment ON apartment_amenities(apartment_id);
CREATE INDEX idx_apartment_amenities_amenity ON apartment_amenities(amenity_id);
